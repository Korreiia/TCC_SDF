...
<div class="formulario">
        <form action="{{ route('atualizarInventario',['id'=>$inventarios->id]) }}" method="post">
          @method('put')
            ...
            <input type="number" name="dataentrada" value="{{ $inventarios->dataentrada }}" placeholder="Data de Entrada" required>
            <input type="text" name="descricao" value="{{ $inventarios->descricao }}" placeholder="Descricao">
            <input type="text" name="estadoconservacao" value="{{ $inventarios->estadoconservacao }}" placeholder="Estado de Conservação" required>
            ...
            <input type="text" name="remetente" value="{{ $inventarios->remetente }}" placeholder="Remetente">
